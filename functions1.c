 ...
 * @types: this is the List a of all arguments
 ...
 * @size: the specifier of the size
...
/**
 * print_octal - this prints an unsigned number in octal
 * @types: this is the List a of all arguments
 * @buffer: this is the buffer array to handle print
 * @flags:  this calculates the active flags
 * @width: this gets the width
...
/**
 * print_hexa - A function that prints a hexadecimal number in
 * lower or upper
 * @types: this is the List a of all arguments
 * @map_to: the array of values to map the number to
 * @buffer: this is the buffer array to handle print
 * @flags:  this calculates the active flags
 * @flag_ch: this also calculates active flags
 * @width: this gets the width
 * @precision: specification of the precision
 * @size: the specifier of the size
